    ...
    <Container>
      ...
      <InputContainer>
        ...
        <Input
          ...
          placeholder="나이"
          value={age.value}
          onChange={(e) => handleInputChange(setAge, e.target.value, validateAge)}
        />
        <Mes>{age.error}</Mes>
        ...
        <Input
          ...
          onChange={(e) => handleInputChange(setPassword, e.target.value, validatePassword)}
        />
        ...
        <Input
          ...
          onChange={(e) =>
            handleInputChange(setPasswordConfirm, e.target.value, validatePasswordConfirm)
          }
        />
