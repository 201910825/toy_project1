...
function Popular() {
  ...
  const apiUrlUpcoming = `https://api.themoviedb.org/3/movie/popular?language=en-US&page=${currentPage}`;
  ...
  return (
    <Container>
      <ReuseMovie apiUrl={apiUrlUpcoming} totalPages={totalPages} updateTotalPages={updateTotalPages} />
      <Pagination>
